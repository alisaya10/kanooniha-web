...
import strategicPlanImage from '@/assets/images/strategic-plan-image.png'
...
const DashboardStrategicPlan = () => {
  ...
  return (
    <div
      className={`flex lg:flex-row flex-col bg-[#FDE2EB] rounded-xl py-5 pr-[30px] pl-6 items-center ${isError || isLoading ? 'min-h-[200px]' : ''} gap-6`}
    >
      ...
      {!isLoading && textbooks && !isError && (
        <>
          <img src={strategicPlanImage} alt="textbook" className="w-[138px] h-[91px]" />
          <div className="w-full">
            ...
            {textbooks?.link && (
              <Button
                ...
                className="w-full bg-[#ED6D9D] text-white border-0 font-bold h-[40px]"
              >
...
export default DashboardStrategicPlan
