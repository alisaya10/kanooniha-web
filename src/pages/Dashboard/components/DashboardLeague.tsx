...
const DashboardLeague = () => {
  ...
  const news = (Array.isArray(data) ? data : []).slice(0, 5)
  return (
    <div className="bg-boxGray py-6 px-4 rounded-xl relative min-h-[500px]">
      <div className="flex items-center justify-between w-full border-b border-b-gray-300 pb-4 mb-4">
        <div className="flex items-center gap-2">
          ...
          <p className="text-textGray font-bold text-base">
            لیگ درس محور برمبنای سوالات صحیح
          </p>
        </div>
      </div>
      ...
      {!isLoading && !isError && (
        <div className="space-y-4">
              ...
              >
                <div className="flex items-center">
                  <img
                    ...
                    alt="news-image"
                  />
                  <p className="text-textGray700 text-sm font-bold">علی پناهی</p>
                </div>
          ...
          {news.length === 0 && (
            <div
              className={`flex flex-col items-center gap-6 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2`}
            >
              <img
                src={notFoundImage}
